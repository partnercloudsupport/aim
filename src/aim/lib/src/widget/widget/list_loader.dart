...
class ListLoaderWidget extends StatelessWidget {
  final ListLoaderController controller;
  final OnRefresh onRefresh;
  final OnLoadMore onLoadMore;
  final ScrollView child;


  ListLoaderWidget({Key key, @required this.child, this.onRefresh, this.onLoadMore, this.controller}):super(key:key);
