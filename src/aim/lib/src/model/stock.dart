...
class ModelStock {
  ...
  ModelStock(this.id, this.name, this.jianpin, this.quanpin, this.status, this.limit, this.ctime, this.mtime, this.url, this.tidyjs, this.quote);

  factory ModelStock.initWith({String id, String name, String jianpin, String quanpin, String status, String limit, int ctime, int mtime, String url, String tidyjs, ModelQuote quote}) {
    return ModelStock(id, name, jianpin, quanpin, status, limit, ctime, mtime, url, tidyjs, quote);
  }
