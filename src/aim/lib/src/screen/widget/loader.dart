...
class AutoLoader<Model extends StateBase> extends StatefulWidget {
  // redux action object
  final dynamic action;
  // app state selector
  final Model Function(AppState state) selector;
  ...
  AutoLoader({Key key, @required this.action, @required this.selector, @required this.builder}): super(key: key);
